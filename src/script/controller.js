...
var Controller = Class.create({
  ...
  handlePersonNewChildOnly: function(event) {
    var timer = new Timer();
    ...
    try {
      ...
      var changeSet = editor.getGraph().addNewChildWithoutPartner(personID, childParams, numTwins);
      editor.getView().applyChanges(changeSet, true);
    ...
    timer.printSinceLast('=== Total new child without partner runtime: ');
  },
